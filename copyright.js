...
function init() {
	$('div.wideBox h2').fadeIn(1500);
	$('div.wideBox img').delay(1500).fadeIn(500);
	$('div#info').empty();
...
*/
	...
	$('#infoTab').mousedown(function() {
		$(this).animate({top: "-29"}, 0);
		$(this).css("background-image", "url(images/ribbon_v2.png)");
	}).mouseleave(function() {
		$(this).animate({top: "-45"}, 0);
		$(this).css("background-image", "url(images/ribbon_v1.png)");
	}).mouseup(function() {
		$(this).animate({top: "-45"}, 0);
		$(this).css("background-image", "url(images/ribbon_v1.png)");
	});
	
	$('#infoTab, #tophead #arrow, #tophead h1').click(function() {
		$('div.wideBox h2').remove();
		$('div.wideBox img').remove();
	});
