								...
								<td width="75%" align="left">
									<FORM NAME="theForm" ID="theForm" ACTION="#" METHOD="POST">
										<TABLE width="700px">
											...
											<TR>
												<TD class="formLabel">Page Range:</TD>
												<td class ="ask_input" style="width: 350px;">
													<INPUT TYPE="text" NAME="Start_Page" SIZE="2" />
													-
											...
											<TR>
												<TD class="formLabel">Number of students:</TD>
												<td class ="ask_input" colspan="3">
													<INPUT TYPE="text" NAME="Num_Students" SIZE="5" />
												</TD>
											</TR>
											<TR>
												<TD class="formLabel">
